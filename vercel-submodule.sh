...
SUBMODULE_GITHUB=github.com/Project-Ilkka/Fundraising.git

# .gitmodules submodule path
SUBMODULE_PATH=contracts/Fundraising
...
cp -r tmp/* $SUBMODULE_PATH/ # move the submodule to the submodule path
