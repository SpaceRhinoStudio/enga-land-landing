...
<Parallax disabled={disableParallax} let:transform let:x let:y>
  <div class="relative h-[var(--h-screen)] mb-20 md:mb-24 lg:mb-32">
    ...
    <div class="-mt-5 absolute inset-0">
      <div
        class="scale-y-[102%] relative left-1/2 -translate-x-1/2 max-w-screen w-screen h-[var(--h-screen)] children:absolute overflow-hidden"
        style={cn(
      ...
      <!-- reflection -->
      <div
        class="-my-10 py-10 overflow-hidden h-[15vw] min-h-[10rem] relative left-1/2 -translate-x-1/2 max-w-screen w-screen">
